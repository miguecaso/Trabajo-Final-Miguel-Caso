...
if not st.session_state.inicio:
    ...
    st.session_state.nombre = st.text_input("¿Cuál es tu nombre? (Obligatorio). Luego de escribir tu nombre, presiona Enter para que aparezca el ícono y puedas iniciar el test.")
